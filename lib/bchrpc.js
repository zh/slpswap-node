  ...
  async getUtxo(txhash, vout, includeTokenMetadata = true) {
    ...
    if (utxo.outpoint) {
      ...
      if (slpToken) {
        ...
        let tokenMetadata;
        if (utxo.tokenMetadata.v1Fungible)
          tokenMetadata = utxo.tokenMetadata.v1Fungible;
        if (utxo.tokenMetadata.v1Nft1Group)
          tokenMetadata = utxo.tokenMetadata.v1Nft1Group;
        if (utxo.tokenMetadata.v1Nft1Child)
          tokenMetadata = utxo.tokenMetadata.v1Nft1Child;
        if (tokenMetadata) {
          utxo.tokenMetadata.tokenTicker = tokenMetadata.tokenTicker;
          utxo.tokenMetadata.tokenName = tokenMetadata.tokenName;
          utxo.tokenMetadata.tokenDocumentUrl = tokenMetadata.tokenDocumentUrl;
          utxo.tokenMetadata.tokenDocumentHash = tokenMetadata.tokenDocumentHash;
        }
